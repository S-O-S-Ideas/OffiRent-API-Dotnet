...
//            falseoffices.Add(new Office { Id = 70, Address = "calle Jerusalen", Floor = 2, Capacity = 4, AllowResource = true, Punctuation = "85 puntos", Description = "Oficina espaciosa con gran comodidad", Price = 100, Status = true, AccountId = 300, DistrictId = 80 });
//            falseoffices.Add(new Office { Id = 71, Address = "calle Jazmines", Floor = 1, Capacity = 3, AllowResource = true, Punctuation = "99 puntos", Description = "Oficina grande", Price = 80, Status = true, AccountId = 300, DistrictId = 80 });
