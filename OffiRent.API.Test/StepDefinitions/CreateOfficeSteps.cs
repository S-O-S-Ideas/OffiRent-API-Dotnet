...
namespace OffiRent.API.Test.StepDefinitions
{
    ...
    public class CreateOfficeSteps
    {
        ...
        {
            goodResponse = _officeService.SaveAsync(validOffice).Result;
        }
        ...
        {
            priceResponse = _officeService.SaveAsync(pricelessOffice).Result;
        }
        ...
        {
            districtResponse = _officeService.SaveAsync(districtlessOffice).Result;
        }
